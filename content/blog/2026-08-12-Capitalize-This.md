...
So, what are these incidents? I've written about them before ([here]({{< relref "./2026-07-29-Hugging-Face-Incident.md" >}}), [here]({{< relref "./2026-08-04-UK-AISI-Incident.md" >}}), [here]({{< relref "./crashtest.md" >}}), [here]({{< relref "./2026-07-31-Tell-us-a-story.md" >}}), and [here]({{< relref "path/to/document.md" >}})), but let's give Celia's condensed version priority today:
...
>
>A third-party evaluation provider, Irregular, had a misconfigured test environment that allowed models from [OpenAI](https://openai.com/index/third-party-cyber-evaluations-involving-openai-models/), [Anthropic](https://www.anthropic.com/news/investigating-incidents-cybersecurity-evals), and [Meta](https://www.cbsnews.com/news/meta-says-ai-model-breached-third-party-company/) to access the internet when they weren’t supposed to. 
>
>The UK’s AI Security Institute (AISI) [reported](https://www.aisi.gov.uk/blog/incident-report-unsanctioned-agent-behaviour-during-cyber-testing) that Anthropic’s Mythos 5 tried to trick real people into adding malicious code to an open-source project, then hid the evidence. 
>
