...
Zvi Mowshowitz used the metaphor as the theme for his blog post yesterday, describing The [Three AI Pills](https://thezvi.substack.com/p/the-three-ai-pills?r=67wny) that people can take:
...
If someone doesn't even believe in the ability of AI to do the things that AI is doing right now ("they are nothing but stochastic parrots, predicting the next word"), it is hard to speak to them about the perils of the next generation of model.

Today's [post](https://thezvi.substack.com/p/ai-180-no-longer-in-charge) by Zvi (as well as [news from Axios](https://www.axios.com/2026/08/06/openai-hugging-face-black-hat)) is even more dire, frankly:
...
He is speaking about an "excursion" taken by OpenAI models, back in May, and just now being documented and released to the public. This account reveals, effectively, the set of capabilities set that made the Hugging Face Incident possible. It even included a hack of Artifactory (the mechanism the models used a couple of months later, only using a different technique since OpenAI had patched the hole in the proxy they used the first time) (Sabin 2026).
...
I think it is going to take a calamity (major financial disaster or lives lost) before people take this seriously. Over and over again we've seen news that includes the phrase "warning shot," when something bad happens and AI is responsible. Even more tellingly, the people who created AI have said, [over and over and over again](./warnings.md), that this will end in disaster. Yet the frontier labs keep building it.
