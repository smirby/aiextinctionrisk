...
Yesterdau we learned that almost 1200 employees of the "Frontier Labs" (code for Google DeepMind, Anthropic, OpenAI, and Facebook Meta). The petition, called "[Pacing the Frontier](https://www.pacingthefrontier.com/)," is not a call to stop development but it does seek to ensure there is an option to pace (slow down? Stop, perhaps?) development if necessary.
...
What spurred this initiative? It looks like the trigger was recursive self-improvement, something we have focused on our book as particularly dangerous and a likely prelude to loss of control (link to book chapter here). Still, it comes at a bit of an awkward time, as the major labs have also been arguing for openness as the solution to AI safety.
