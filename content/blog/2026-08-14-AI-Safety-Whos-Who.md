...
The other issue to keep in mind is that many of the sources that one might follow are themselves aggregators. So you are going to see the same thing multiple times. From my point of view that's just the cost of doing business, and its also a useful bell-weather for seriousness. In other words, if you read the same story everywhere (e.g., The Incidents&trade;) then you might know that it is something big.
...
Maybe the first place to start is at the edges. There are some people who (still) have not taken the red pill (see [my post about AI pills]({{< relref "./2026-08-06-Take-a-pill.md" >}})) and we can't forget about them, since they still shape discussion in some ways.
...
- [**The AI Safety Newsletter (by CAIS)**](https://safe.ai/newsletter)**:** Published weekly by the Center for AI Safety, this is arguably the best single roundup covering technical developments, public policy, and industry news with concise summaries.
- [**Import AI (by Jack Clark)**](https://jack-clark.net/)**:** Written by Anthropic co-founder Jack Clark, this weekly newsletter covers frontier machine learning research, safety implications, and global governance with deep technical and policy analysis.
- [**ML Safety Newsletter (by Dan Hendrycks)**](https://newsletter.mlsafety.org/)**:** Focuses specifically on technical research papers in machine learning safety, robust alignment, monitoring, and systemic safety.
- [**AI Alignment Newsletter Archive**](https://rohinshah.com/alignment-newsletter/)**:** Curated historically by Rohin Shah (Google DeepMind), this is a foundational archive covering core technical alignment literature and arguments.

## 2. Community Hubs & Discussion Forums

- [**AI Alignment Forum**](https://www.alignmentforum.org/)**:** The primary hub where technical researchers, theoretical alignment thinkers, and governance experts publish research write-ups, debates, and literature reviews.
- [**LessWrong (AI Section)**](https://www.lesswrong.com/)**:** A major forum where many AI safety concepts originated; heavily overlaps with the Alignment Forum and features broader discussions on forecasting, rationality, and existential risk.
- [**AISafety.world**](https://aisafety.world/)**:** An interactive map of the AI safety ecosystem, tracking active organizations, research labs, funders, and community initiatives.

## 3. Governance, Policy & Incident Trackers

- [**Center for Security and Emerging Technology (CSET)**](https://cset.georgetown.edu/)**:** Provides data-driven analysis and reports on AI policy, compute tracking, export controls, and national security implications.
- [**AI Incident Database**](https://incidentdatabase.ai/)**:** A dedicated collection tracking real-world failures, harms, and misalignments of AI systems in production.
- [**OECD AI Policy Observatory (OECD.AI)**](https://oecd.ai/)**:** Great for tracking international regulations, country-level strategies, and standardized safety metrics.

## 4. Frontier Labs’ Safety Blogs

To track policies and safety releases directly from the frontier builders:

- [**Anthropic Research & Policy**](https://www.anthropic.com/research)**:** Covers mechanistic interpretability, responsible scaling policies (RSP), and constitutional AI.
- [**OpenAI Safety & Alignment**](https://openai.com/safety/)**:** Features preparedness frameworks, evaluations, and red-teaming reports.
- [**Google DeepMind Responsibility & Safety**](https://deepmind.google/discover/safety-responsibility/)**:** Covers safe deployment, socio-technical risks, and capability evaluations.
