...
Günther Anders was one of the most well-known (in Europe) thinkers about technology and technological change. Born in 1902, Anders was a student of Edmund Husserl (and Heidegger, but that's a [whole other story](https://www.journals.uchicago.edu/doi/10.1086/690967)), and a peer of Herbert Marcuse. In our book we rely on concepts from Marcuse - like instrumental rationality - and I got interested in Anders because of the Marcuse connection, and because there are aspects of his work that resonate with an AI Safety perspective.
...
It's almost as if we cannot contemplate our own destruction. As John Thornhill put it recently, in the context of discussions about AGI, "A sense of fatalistic inevitability about the technology’s evolution is triggering something close to despair" (Thornhill 2026). This is exactly the kind of thing Anders predicted, calling it a kind of Promethean shame, in which humans prefer what is made (e.g. AI) over the maker (e.g., humans) (Anders 2016, p. 31). Thornhill's article goes on to relate how in some AI research circles, a kind of quiet acceptance is starting to circulate: should we be focused on creating a worthy successor, as [contemplated by Dan Faggella](https://danfaggella.com/worthy/)?

For me, in the context of our book, this raises the following question: Can  the fear (and for some, the desire) to be replaced by machines/AI be connected to Anders' concept of feeling shame the we are not (industrial) products?  Liessmann states that "One of the central premises of [Anders'] philosophy states: the products of our technical intelligence are more than they appear" (Liessmann 2011) and thus more of a challenge to our continuing existence.  Or, in Anders own words:
...
The question then is: *are we antiquated*? Is our demise/departure inevitable? If not, what can we do about it? Does Anders provide guidance for how to bridge the gap, to take notice and ultimately take responsibility for our creations?

As I was finishing this blog post I found Elke Schwarz' excellent article *Günther Anders in Silicon Valley* (Schwarz 2019). Written long before the rise of LLMs and agent swarms, it is remarkably prescient. And, helpfully, it focuses in immediately on this issue of responsibility and consequences. In the abstract to the article, she directs our attention to our responsibilities and developing a moral imagination:
...
Schwarz helpfully returns us to *Die Antiquiertheit* and lays out the three theses from that work: "1) that we are no match for the perfection of our products, 2) that our scope for producing things outstrips our ability to imagine their impact and take responsibility, and 3) that we seem to assume that it is permissible (if not desirable) to do what we are capable of doing" (Schwartz, .p.96). I can't think of a better description of the situation with AI today: we are no match for the most advanced models, we are only just barely aware of their implications and dangers, and those building them seem to feel perfectly justified in building more and better models because they can.
